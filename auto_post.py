...
class PhilosophyBotOrchestrator:
    """記事生成から投稿までを統括するクラス"""
    ...
    def __init__(
        ...
        self.article_gen = ArticleGenerator(anthropic_api_key)
...
def main():
    ...
    result = bot.create_and_post_article(
        ...
        author_experience="""私自身、常に何かを追い求め、達成しては虚しさを感じるというループに、長年悩まされてきました。
でも、ショーペンハウアーの言葉が、そのループから一歩引いて自分を眺める視点をくれました。""",
